...
//en formato arrow function y refactorizando las anteriores dos funciones quedan...
// exports.getBlogEntries = () => entries;
// exports.getBlogEntry = id => entries.find(post => post.id === +id)  el +id es porque recibe numerico y espera string
